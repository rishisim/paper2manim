...
const SHORTCUT_GROUPS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: 'b',         description: 'Switch to the segment board (primary live view)' },
      { key: 'f',         description: 'Switch to the live process feed' },
      { key: 't',         description: 'Switch to inspect view for chronological debugging' },
      { key: '↑ / ↓',     description: 'Move through board rows or inspect events' },
      { key: 'Enter',     description: 'Toggle the selected board drawer or inspect item' },
      { key: 'g',         description: 'Return the board or inspect view to live follow mode' },
      { key: '1..5',      description: 'Filter inspect view by all/tools/reasoning/code/status' },
